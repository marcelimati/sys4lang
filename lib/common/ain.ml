...
let to_buffer ain =
  ...
  (* Both [FNCT] and [DELG] carry a section-size prefix after the tag.
     In v11 the Ixseal loader uses it to skip/validate the section, so
     writing zero makes the file unloadable. For pre-v11 targets keep
